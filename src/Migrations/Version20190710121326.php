 ...
 */
final class Version20190710121326 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job_category ADD name VARCHAR(255) DEFAULT NULL, DROP names, CHANGE user_id user_id INT DEFAULT NULL');
