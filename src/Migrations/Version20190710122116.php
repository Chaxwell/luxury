 ...
 */
final class Version20190710122116 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job_category ADD user_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE job_category ADD CONSTRAINT FK_610BBCBAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_610BBCBAA76ED395 ON job_category (user_id)');
